...
var forgotPasswordHandler = function (req, h) { return __awaiter(void 0, void 0, void 0, function () {
    var email, code, password, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                email = req.payload.email;
                code = randomstring_1.generate({ length: 9 });
                password = bcryptjs_1.hashSync(code, bcryptjs_1.genSaltSync(4));
                return [4, model_1.userModel.updateOne({ email: email }, { password: password })];
            case 1:
                _a.sent();
                mail_1.mailTo({
                ...
                return [2, h.response({ message: "account recovery was successful." })];
            case 2:
                error_1 = _a.sent();
