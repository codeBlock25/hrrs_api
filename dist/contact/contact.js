...
exports.contactRequestHandler = exports.contactRequestValidator = void 0;
...
exports.contactRequestValidator = {
    ...
    failAction: function (_r, _h, error) {
        return boom_1.badRequest(JSON.stringify(error));
    },
};
var contactRequestHandler = function (req, h) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, first_name, last_name, subject, message, validateAuth, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.payload, first_name = _a.first_name, last_name = _a.last_name, subject = _a.subject, message = _a.message;
            ...
            case 2:
                ...
                return [2, h.response({ message: "sent" })];
            case 3:
                error_1 = _b.sent();
...
exports.contactRequestHandler = contactRequestHandler;
